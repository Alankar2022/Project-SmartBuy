package com.app.dao;                 //it gets data from db
...
public interface UserRepository extends JpaRepositoryImplementation<User, Integer> {
	...
	Optional<User> findByEmail(String email);                         //here page not  goes outside,
	@Query("select u from User u where u.id = ?1")               //we have managed  it from inside
