package com.app.controller;    //it gets data from UI
...
@RestController
@RequestMapping("/users")                                      //for react next 2 lines
@CrossOrigin(origins="http://localhost:3000")
public class UserController {
	
	@Autowired                        //implemented all methods of Iuserservice               
	IUserService user;                 //interface
	...
	//Adding new user detail in user_table
		@PostMapping("/adduser")          //similar to GET and POST
