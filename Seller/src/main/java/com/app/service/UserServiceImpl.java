...
@Service                   //used to mark class as a service provider
@Transactional                          
public class UserServiceImpl implements IUserService {
	...
	public User checkUserByEmail(String email) {
		...
		for(User u:userList) {
			if(u.getEmail().equals(email)) {   //because of this type of error, we creating new project, we hava created this class in dto
				return u;
			}
		}
